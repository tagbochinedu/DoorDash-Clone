    ...
    <div className="bg-footer px-16 py-8  ">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-around mt-24">
        ...
        <div className="md:w-5/12">
          <div className="bg-playstore rounded-lg md:mb-6 mb-3 w-40 md:ml-auto mx-auto">
            <a
              href="https://app.adjust.com/bo0s4gx?engagement_type=fallback_click&tracker_limit=100000"
          ...
          <div className="bg-playstore flex rounded-lg w-40 mb-6 md:ml-auto mx-auto">
            <a
