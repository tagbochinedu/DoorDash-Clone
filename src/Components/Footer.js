  ...
  return (
    <div className="bg-footer px-16 py-8  ">
      <div className="flex justify-around">
        <div className="md:w-5/12 w-6/12">
          ...
          <div className="md:flex justify-between text-center md:text-left">
            <ul>
              <li className="my-1.5">
                <a
                  ...
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  New York City
                </a>
              </li>
            ...
            <ul>
              ...
              <li className="my-1.5">
                <a
                  href="https://www.doordash.com/food-delivery/dallas-tx-restaurants/"
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  Dallas
                </a>
              ...
              <li className="my-1.5">
                <a
                  href="https://www.doordash.com/food-delivery/melbourne-vic-restaurants/"
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  Melbourne
                </a>
              ...
              <li className="my-1.5">
                <a
                  href="https://www.doordash.com/food-delivery/sydney-nsw-restaurants/"
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  Sydney
                </a>
              ...
              <li className="my-1.5">
                <a
                  href="https://www.doordash.com/food-delivery/montreal-qc-restaurants/"
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  Montreal
                </a>
              ...
              <li className="my-1.5">
                <a
                  href="https://www.doordash.com/food-delivery/"
                  className="text-gray-300 text-sm no-underline  font-semibold hover:underline hover:text-white"
                >
                  All Cities
                </a>
        ...
        <div className="md:w-5/12 w-6/12">
          <h4 className="text-gray-200 font-bold text-md mb-3">
            Top Cuisines Near You
          </h4>
          <div className="md:flex justify-start text-center md:text-start">
            <ul className="md:w-2/4">
              {" "}
              <li className="my-1.5">
                <a
      ...
      <div className="flex flex-col-reverse md:flex-row justify-around mt-24">
        ...
        <div className="md:w-5/12">
          <div className="bg-playstore rounded-lg md:mb-6 mb-3 w-40 md:ml-auto mx-auto md:mx-0">
          ...
          <div className="bg-playstore flex rounded-lg w-40 mb-6 md:ml-auto mx-auto md:mx-0">
            <a
      ...
      <div className="justify-around flex-col-reverse md:flex-row flex mt-8">
        <div className="flex justify-around md:w-6/12 items-center">
          <svg
            height="24"
          ...
          <ul className="flex items-center">
            <li className="mx-1.5">
              <a
                ...
                className="text-gray-300 text-xs no-underline hover:underline hover:text-white"
              >
                Terms of Service
              </a>
            </li>
            <li className="mx-1.5">
              <a
                href="https://www.doordash.com/privacy/?language=en"
                className="text-gray-300 text-xs no-underline hover:underline hover:text-white"
              >
                Privacy
              </a>
            ...
            <li className="mx-1.5">
              <a
                href="https://help.doordash.com/consumers/s/privacy-policy-us?language=en#section-11"
                className="text-gray-300 text-xs no-underline hover:underline hover:text-white"
              >
            ...
            <li className="mx-1.5">
              <a
                href="https://www.doordash.com/food-delivery/?language=en"
                className="text-gray-300 text-xs no-underline hover:underline hover:text-white"
              >
                Delivery Locations
              </a>
            </li>
            <li className="text-gray-300 text-xs mx-1.5">© 2022 DoorDash</li>
          </ul>
        </div>
        <div className="md:w-4/12 flex justify-center md:justify-end mb-4">
          <a href="http://facebook.com/doordash">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <a href="http://twitter.com/doordash" className='mx-2'>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <a href="http://instagram.com/doordash">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
